...
file_path = 'logs/optimization_results.csv'
out_folder = 'plots/'
...
plt.savefig(f'{out_folder}log_decay_rate_vs_alpha.png')
...
plt.legend()
plt.grid(True, which='both', linestyle='--', linewidth=0.5)
plt.savefig(f'{out_folder}log_decay_rate_vs_gamma.png')
...
plt.legend()
plt.grid(True, which='both', linestyle='--', linewidth=0.5)
plt.savefig(f'{out_folder}log_decay_rate_vs_sparsity.png')
...
plt.legend()
plt.grid(True, which='both', linestyle='--', linewidth=0.5)
plt.savefig(f'{out_folder}log_decay_rate_vs_accuracy.png')
...
plt.legend()
plt.grid(True, which='both', linestyle='--', linewidth=0.5)
plt.savefig(f'{out_folder}log_decay_rate_vs_all.png')